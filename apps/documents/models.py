...
#         _("verbose_name"), default="", null=True, blank=True)
#     branch = models.ForeignKey("branches.Branch", verbose_name=_(
...
#     order = models.ForeignKey("documents.Orders", verbose_name=_(
#         "buyurtma"), on_delete=models.DO_NOTHING, null=True, blank=True)
...
#     prixod = models.ForeignKey(
#         "documents.Prixod", verbose_name=_(""), on_delete=models.CASCADE)
...
#     tim_table = models.ForeignKey(Timtable, verbose_name=_(
#         "Davomat hujjati"), on_delete=models.CASCADE)
