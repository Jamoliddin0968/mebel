...
class ReceiveSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        branch = obj.branch
        warehouse, _ = WareHouse.objects.get_or_create(branch=branch)
        receive_item_list = []
        ...
        for item in items:
            ...
            warehouse_item,_ = WareHouseItem.objects.get_or_create(product_id=item.get('product'),warehouse=warehouse)
